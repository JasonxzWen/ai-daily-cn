...
Snapshot: 144 registered collection entries, generated mode deterministic.
...
| `open_source_platforms` 开源、模型平台与代码生态 | 34 | 4 | 7 | 27 | 0 |
| `tracking_metrics` 榜单与持续指标 | 3 | 3 | 3 | 0 | 0 |
| `builder_community` Builder 与社区原始信号 | 35 | 1 | 8 | 26 | 1 |
...
| 30.027 | `general-news-google-big-tech-company-watch` | Google News Big Tech Company Watch RSS | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 30.028 | `content-huggingface-openai` | OpenAI Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.029 | `content-huggingface-anthropic` | Anthropic Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.030 | `content-huggingface-zai-org` | Z.ai Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.031 | `content-huggingface-meta-llama` | Meta Llama Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.032 | `content-huggingface-paddlepaddle` | PaddlePaddle Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.033 | `content-huggingface-microsoft` | Microsoft Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.034 | `content-huggingface-nvidia` | NVIDIA Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
...
<!-- inventory-section:builder_community count:35 -->
...
| 50.025 | `content-bens-bites` | Ben's Bites | `unmapped` | `rss` | `optional` | `T2` | `aggregator` | `-` | `configured` |
| 50.026 | `content-interconnects` | Interconnects | `unmapped` | `rss` | `optional` | `T2` | `secondary` | `-` | `configured` |
| 50.027 | `content-the-magnifier-ai` | The Magnifier AI | `unmapped` | `html_index` | `optional` | `T2` | `secondary` | `-` | `configured` |
| 50.028 | `content-crunchbase-ai-news` | Crunchbase News AI | `unmapped` | `html_index` | `optional` | `T3` | `secondary` | `-` | `configured` |
| 50.029 | `content-planet-ai` | Planet AI | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 50.030 | `general-news-google-ai` | Google News AI RSS | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 50.031 | `general-news-google-ai-policy` | Google News AI Policy RSS | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 50.032 | `general-news-google-aigc-content` | Google News AIGC Content Industry RSS | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 50.033 | `general-news-google-aigc-video-image-game` | Google News AIGC Video Image Game RSS | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 50.034 | `intermediary-leiphone` | Leiphone | `unmapped` | `rss` | `optional` | `T3` | `intermediary` | `-` | `configured` |
| 50.035 | `intermediary-ifanr` | iFanr | `unmapped` | `rss` | `manual` | `T3` | `intermediary` | `-` | `configured` |
