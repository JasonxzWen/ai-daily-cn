...
Snapshot: 145 registered collection entries, generated mode deterministic.
...
| `open_source_platforms` 开源、模型平台与代码生态 | 36 | 4 | 7 | 29 | 0 |
| `tracking_metrics` 榜单与持续指标 | 3 | 3 | 3 | 0 | 0 |
| `builder_community` Builder 与社区原始信号 | 34 | 1 | 8 | 25 | 1 |
| `platform_cn_media` 中文平台与媒体线索 | 6 | 1 | 0 | 5 | 1 |
...
<!-- inventory-section:open_source_platforms count:36 -->
...
| 30.019 | `content-arxiv-cs-ai` | arXiv cs.AI | `arxiv-papers` | `rss` | `optional` | `T0` | `primary` | `-` | `configured` |
| 30.020 | `content-arxiv-cs-cl` | arXiv cs.CL | `arxiv-papers` | `rss` | `optional` | `T0` | `primary` | `-` | `configured` |
| 30.021 | `content-arxiv-cs-lg` | arXiv cs.LG | `arxiv-papers` | `rss` | `optional` | `T0` | `primary` | `-` | `configured` |
| 30.022 | `content-arxiv-cs-ma` | arXiv cs.MA | `arxiv-papers` | `rss` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.023 | `content-arxiv-stat-ml` | arXiv stat.ML | `arxiv-papers` | `rss` | `optional` | `T0` | `primary` | `-` | `configured` |
| 30.024 | `content-huggingface-daily-papers` | Hugging Face Daily Papers | `huggingface-daily-papers` | `huggingface_daily_papers_api` | `optional` | `T2` | `aggregator` | `-` | `configured` |
| 30.025 | `content-ml-papers-week` | ML Papers of the Week | `ml-papers-week` | `github_report_markdown` | `optional` | `T2` | `aggregator` | `-` | `configured` |
| 30.026 | `content-builder-lilian-weng` | Lil'Log (Lilian Weng) | `unmapped` | `rss` | `optional` | `T1` | `secondary` | `-` | `configured` |
| 30.027 | `content-awesome-ai-news` | Awesome AI News | `unmapped` | `github_report_markdown` | `optional` | `T2` | `aggregator` | `-` | `configured` |
| 30.028 | `content-salvatorera-ml-news-week` | ML & AI News of the Week | `unmapped` | `github_report_markdown` | `optional` | `T2` | `aggregator` | `-` | `configured` |
| 30.029 | `general-news-google-big-tech-company-watch` | Google News Big Tech Company Watch RSS | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 30.030 | `content-huggingface-openai` | OpenAI Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.031 | `content-huggingface-anthropic` | Anthropic Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.032 | `content-huggingface-zai-org` | Z.ai Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.033 | `content-huggingface-meta-llama` | Meta Llama Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.034 | `content-huggingface-paddlepaddle` | PaddlePaddle Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.035 | `content-huggingface-microsoft` | Microsoft Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 30.036 | `content-huggingface-nvidia` | NVIDIA Hugging Face Organization | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
...
<!-- inventory-section:builder_community count:34 -->
...
| 50.009 | `content-huawei-newsroom` | Huawei Newsroom | `unmapped` | `html_index` | `core` | `T0` | `primary` | `-` | `configured` |
| 50.010 | `content-xiaomi-investor-relations` | Xiaomi Investor Relations | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 50.011 | `content-jd-investor-news` | JD.com Investor News | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 50.012 | `content-netease-company-news` | NetEase Company News | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 50.013 | `content-kuaishou-company-news` | Kuaishou Company News | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 50.014 | `content-meituan-investor-relations` | Meituan Investor Relations | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 50.015 | `content-builder-simon-willison` | Simon Willison's Weblog | `unmapped` | `rss` | `optional` | `T1` | `secondary` | `-` | `configured` |
| 50.016 | `content-runway-changelog` | Runway Changelog | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 50.017 | `content-luma-changelog` | Luma Changelog | `unmapped` | `html_index` | `optional` | `T1` | `primary` | `-` | `configured` |
| 50.018 | `content-pika-product` | Pika Product Updates | `unmapped` | `html_index` | `optional` | `T2` | `primary` | `-` | `configured` |
| 50.019 | `content-kling-product` | Kling Product Updates | `unmapped` | `html_index` | `optional` | `T2` | `primary` | `-` | `configured` |
| 50.020 | `content-unity-muse` | Unity Muse | `unmapped` | `html_index` | `optional` | `T2` | `primary` | `-` | `configured` |
| 50.021 | `content-nature-machine-learning` | Nature Machine Learning | `unmapped` | `rss` | `core` | `T0` | `secondary` | `-` | `configured` |
| 50.022 | `content-techcrunch-enterprise` | TechCrunch Enterprise | `unmapped` | `rss` | `optional` | `T3` | `intermediary` | `-` | `configured` |
| 50.023 | `content-latent-space` | Latent.Space | `unmapped` | `rss` | `optional` | `T2` | `secondary` | `-` | `configured` |
| 50.024 | `content-smol-ai-news` | Smol AI News | `unmapped` | `rss` | `optional` | `T2` | `aggregator` | `-` | `configured` |
| 50.025 | `content-interconnects` | Interconnects | `unmapped` | `rss` | `optional` | `T2` | `secondary` | `-` | `configured` |
| 50.026 | `content-the-magnifier-ai` | The Magnifier AI | `unmapped` | `html_index` | `optional` | `T2` | `secondary` | `-` | `configured` |
| 50.027 | `content-crunchbase-ai-news` | Crunchbase News AI | `unmapped` | `html_index` | `optional` | `T3` | `secondary` | `-` | `configured` |
| 50.028 | `content-planet-ai` | Planet AI | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 50.029 | `general-news-google-ai` | Google News AI RSS | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 50.030 | `general-news-google-ai-policy` | Google News AI Policy RSS | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 50.031 | `general-news-google-aigc-content` | Google News AIGC Content Industry RSS | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 50.032 | `general-news-google-aigc-video-image-game` | Google News AIGC Video Image Game RSS | `unmapped` | `rss` | `optional` | `T3` | `aggregator` | `-` | `configured` |
| 50.033 | `intermediary-leiphone` | Leiphone | `unmapped` | `rss` | `optional` | `T3` | `intermediary` | `-` | `configured` |
| 50.034 | `intermediary-ifanr` | iFanr | `unmapped` | `rss` | `manual` | `T3` | `intermediary` | `-` | `configured` |

### 中文平台与媒体线索 (`platform_cn_media`)

<!-- inventory-section:platform_cn_media count:6 -->

| Order | Source ID | Name | Logical source | Kind | Enablement | Tier | Authority | Platform | Config status |
|---:|---|---|---|---|---|---|---|---|---|
| 60.001 | `wechat-industry-whitelist-manual` | WeChat Industry Whitelist Manual Intake | `wechat-platform` | `manual` | `manual` | `T3` | `intermediary` | `-` | `manual_review+configured` |
| 60.002 | `intermediary-36kr` | 36Kr | `unmapped` | `rss` | `optional` | `T3` | `intermediary` | `-` | `configured` |
| 60.003 | `intermediary-qbitai` | QbitAI | `unmapped` | `rss` | `optional` | `T3` | `intermediary` | `-` | `configured` |
| 60.004 | `intermediary-jiqizhixin` | Jiqizhixin | `unmapped` | `html_index` | `optional` | `T3` | `intermediary` | `-` | `configured` |
| 60.005 | `intermediary-infoq-cn` | InfoQ CN | `unmapped` | `rss` | `optional` | `T3` | `intermediary` | `-` | `configured` |
| 60.006 | `intermediary-sspai` | SSPAI | `unmapped` | `rss` | `optional` | `T3` | `intermediary` | `-` | `configured` |
