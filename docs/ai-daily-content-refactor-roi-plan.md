...
- `hot_blogs` 的公开名字还是“热门技术博客”，实际限制了它的内容边界，难以自然容纳“技不止术”。
...
### 2. 把 `hot_blogs` 公开改名为“技不止术”

- ROI：最高
- 为什么先做：
  这是把日报从“技术博客池”拉向“内容/产品型长日报”的最短路径，且不需要推翻 schema。
- 这轮怎么落：
  字段仍保留 `hot_blogs`，公开标题改成“技不止术”，允许承载产品拆解、平台策略、内容生态、组织方法和高质量访谈/播客。
