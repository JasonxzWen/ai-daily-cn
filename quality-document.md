...
| GitHub Trending fact lane | B | Focused enrichment tests pass 16/16; affected unit suite passes 253/253; final validation passes 905 total / 903 pass / 0 fail / 2 skipped with build-clean, 194-file privacy, E2E, Harness, source/design/workflow/DAG and diff gates | Skipped: existing report/interaction fields changed value but no Web composition changed; only `1280x900` is supported | Good | Scope language, repository language, same-scope source-rank history, and README content-SHA cache now have separate deterministic contracts | Three fresh merged-main runs must prove Top10 metadata coverage, truthful cache behavior, and non-generic first-pass GitHub prose; historical bad facts remain immutable evidence | 2026-07-13 |
