...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Daily production entrypoint | B | PR #290/#291 are merged; the 2026-07-10 non-publish run proved same-run Source Watch, and the 2026-07-07 preview exposed S-70 before backfill. HTML-index fact boundaries, Fable identity guards, and the public 2026-07-08 correction now pass 907 total / 905 pass / 0 fail / 2 skipped | The corrected 2026-07-08 page passes 1280x900 and 375x812 with 0 blocking/degraded checks; fresh merged-main S-70 replay remains | Good | Fixtures cover stage receipts, fingerprints, date-bound proof, source date, binding integrity, score precedence, automation inventory, exact retired-section boundaries, adjacent-card isolation, identity-only special prose, and historical source alignment | Follow-up PR/CI/merge and fresh terminal historical replay remain; missing backfills stay unpublished until historical discovery truth is proven | 2026-07-10 |
