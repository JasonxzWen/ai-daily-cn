...
function githubTrendingItem(candidate, meta, index) {
  ...
  return {
    ...
    language: meta.repository_language || candidate.repository_language || meta.language || candidate.language || "",
...
function normalizeCandidate(rawCandidate, context) {
  ...
  const candidate = {
    ...
    ...(rawCandidate.language ? { language: trimText(rawCandidate.language, 80) } : {}),
    ...(rawCandidate.window ? { window: trimText(rawCandidate.window, 40) } : {}),
    ...(rawCandidate.repository_language ? { repository_language: trimText(rawCandidate.repository_language, 80) } : {}),
