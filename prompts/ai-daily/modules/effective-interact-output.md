...
- interaction input 必须保留日报的日期、覆盖时间范围、摘要、主体信息、非空的热门技术博客、GitHub Trending Top 10、Builder 观察、社区线索、`source_audit`、自检和结构化 JSON 链接；空数组对应板块不要渲染到正文和导航中；国内/中文动态并入现有栏目，不生成独立“国内动态”导航项。
