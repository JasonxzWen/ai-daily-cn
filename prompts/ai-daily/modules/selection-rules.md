...
- 主体信息目标为 5-30 条；5 是低信号日最低值，5-20 是常规舒适区，21-30 是高信号日可接受区间。每条公开正文只展示标题、2-3 句/行可追溯事实概括和来源链接，并用 `**加粗**` 和 `==高亮词==` 标出实体、变化、限制或关键结论。`==高亮词==` 是正文文字强调，不是 tag/chip。不要为了凑数加入低质量内容。
- 读者不是只看工程实现的人，而是同时关心内容、产品、平台、策略与工程的一线从业者。日报要接近内容 / 产品型长日报：不仅回答“技术上有什么更新”，还要回答“哪些变化会影响产品判断、内容供给、平台分发、组织动作或开发工作流”。
- `main_items` 是公开短新闻主线，使用黑名单剔除而不是官方/一手白名单准入。官方、一手、论文、GitHub 或多源确认材料用于排序和保留优先级；低风险、可披露边界的 GitHub、Builder/X、热门博客、社区和白名单公众号线索可以补位进入主体。`model_releases` 仅保留为历史兼容的结构化字段，不生成公开栏目。融资、估值、价格、benchmark、安全事故、监管、模型能力等高风险事实仍需官方/一手或多源确认。
